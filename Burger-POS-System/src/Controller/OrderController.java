...
//	}
    ...
    public static boolean updateOrder(String orderId, String customerId, String customerName, int orderStatus, int orderQTY, double orderValue) {
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            if (existingOrder.getOrderId().equals(orderId)) {
                ...
                existingOrder.setOrderQTY(orderQTY);
                existingOrder.setOrderValue(orderValue);
                return true;
            }
        }
        return false;
